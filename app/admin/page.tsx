...
if (!authenticated) {
return ( <main className="admin-shell"> <div className="admin-box login-box"> <p className="admin-eyebrow"> <span />
Secure control room </p>
...
return ( <main className="admin-shell"> <div className="admin-box admin-box-wide"> <div className="admin-header-row"> <div> <p className="admin-eyebrow"> <span />
